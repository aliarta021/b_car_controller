...
<html>
  ...
  <body class="noselect" align="center" style="background-color:white">
    ...
    <img id="cameraImage" src="" style="width:100vw;height:100vh;object-fit:cover"/>
...
void setup(void)
{
  ...
  server.on("/move", moveApi);
  server.on("/speed", speedApi);
  server.on("/light", lightApi);

  wsCamera.onEvent(onCameraWebSocketEvent);
  asyncServer.addHandler(&wsCamera);

  wsCarInput.onEvent(onCarInputWebSocketEvent);
  asyncServer.addHandler(&wsCarInput);
